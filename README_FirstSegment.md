...
- Training the Model with 1 hidden layer([NeuralNetwork_1hiddenlayer.ipynb](../hiep/NeuralNetwork_1hiddenlayer.ipynb)) from  [senate_dataset.csv](../hiep/Resources/senate_dataset.csv). Refer to test result below:
